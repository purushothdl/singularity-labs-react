...
export const Sidebar = ({
  ...
  return (
    <>
      ...
      >
        {/* Content wrapper - removed overflow-hidden that was cutting off content */}
        <div
        ...
        >
          ...
          <nav className="flex flex-col space-y-2">
            <button
              onClick={onClearChat}
              className={`flex items-center px-4 py-2 text-gray-300 rounded-md hover:bg-[#7b52f4]/20 hover:text-white transition-colors ${
                !isExpanded ? 'md:justify-center' : ''
              }`}
            >
              <FiTrash2 className="w-5 h-5 shrink-0" />
              {isExpanded && <span className="ml-3 whitespace-nowrap">Clear Chat</span>}
            </button>
            <button
            ...
            >
              ...
              {isExpanded && <span className="ml-3 whitespace-nowrap">Update Profile</span>}
            </button>
          </nav>
          ...
          <div className="mt-auto">
            ...
            >
              ...
              {isExpanded && <span className="ml-3 whitespace-nowrap">Logout</span>}
            </button>
          </div>
        </div>
      </div>
      ...
      <button
        ...
        className={`absolute top-9 p-1.5 bg-[#7b52f4] rounded-full text-white hover:bg-[#6a42e3] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-[#7b52f4] transition-all duration-300 z-40 ${
